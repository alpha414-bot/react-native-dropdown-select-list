...
export interface SelectListProps  {
    ...
    */
    ...
    /* 
    * Return true if the dropdown as a button, false if it doesn't
    */
    dropdownAsButton?: boolean,
    /* 
        Button Text for additional button under dropdown
    */
    buttonText?: string,

    /* 
    functions that happens after dropdown button is clicked
    */
    onPressButton?: () => void,
